# Generated by Powerlevel10k configuration wizard on 2023-05-15 at 11:16 NZST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    aws_vault                 # custom aws-vault status
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=226
  ...
  # vague attempt at Montoux colours
  typeset -g POWERLEVEL9K_DIR_WORK_VISUAL_IDENTIFIER_EXPANSION='Ⓜ️ '
  typeset -g POWERLEVEL9K_DIR_WORK_FOREGROUND=123
  typeset -g POWERLEVEL9K_DIR_WORK_SHORTENED_FOREGROUND=123
  typeset -g POWERLEVEL9K_DIR_WORK_ANCHOR_FOREGROUND=123
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_PYENV_VISUAL_IDENTIFIER_EXPANSION='(pyenv)'
  ...
  ########################[ vpn_ip: virtual private network indicator ]#########################
  # VPN IP color.
  typeset -g POWERLEVEL9K_VPN_IP_FOREGROUND=208
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=226
  ...
  function prompt_aws_vault() {
    if [ -n "$AWS_VAULT" ]; then
      ...
      if which gdate &>/dev/null; then
        untilsegment=" until $(gdate --date $AWS_CREDENTIAL_EXPIRATION +%H:%M)"
      else
        untilsegment=" until $(date -j -f '%Y-%m-%dT%H:%M:%SZ' $AWS_CREDENTIAL_EXPIRATION +'%H:%M')"
      fi
      p10k segment -f 208 -i "(AWS)" -t "$AWS_VAULT@$AWS_DEFAULT_REGION until $untilsegment"
    fi
  }
